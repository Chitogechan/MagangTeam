...
$table->setHeading('ID', 'Category Id','Dates','Attachment','Dates from','Dates to','Notes','Duration','Position id','Approval1','Approval2', 'Aksi');
...
foreach ($data as $d) {
	...
	$table->addRow($d['id'], $d['category_id'],$d['dates'],$img = "<img height='95px' width='90px' src=".base_url('gambar/' .$d['attachment']).">",$d['dates_from'],$d['dates_to'],$d['notes'],$d['duration'],$d['position_id'],$d['approval1'],$d['approval2'], $aksi);
}
